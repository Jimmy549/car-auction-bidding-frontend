...
export function Navigation() {
  ...
  return (
    <nav className="shadow-sm py-4 px-4 relative">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            href="/about-us"
            className={`text-gray-700 hover:text-[#4A5FBF] ${
              pathname === "/about-us" ? "font-bold text-[#4A5FBF]" : ""
            }`}
          >
            About us
          </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* User Profile Icon - only show after mount to prevent hydration mismatch */}
          {mounted && isAuthenticated && (
            <div className="relative">
              ...
              >
                <div className="w-8 h-8 bg-[#4A5FBF] rounded-full flex items-center justify-center">
          ...
          <div className="px-4 py-2 space-y-1">
            <Link
              ...
              className={`block py-3 px-4 rounded-lg hover:bg-gray-100 ${
                pathname === "/" ? "font-bold text-[#4A5FBF] bg-blue-50" : "text-gray-700"
              }`}
            >
              Home
            </Link>
            <Link
              ...
              onClick={() => setShowMobileMenu(false)}
              className={`block py-3 px-4 rounded-lg hover:bg-gray-100 ${
                pathname === "/car-auction" ? "font-bold text-[#4A5FBF] bg-blue-50" : "text-gray-700"
              }`}
            >
              Car Auction
            </Link>
            <Link
              ...
              onClick={() => setShowMobileMenu(false)}
              className={`block py-3 px-4 rounded-lg hover:bg-gray-100 ${
                pathname === "/sell-your-car" ? "font-bold text-[#4A5FBF] bg-blue-50" : "text-gray-700"
              }`}
            >
              Sell Your Car
            </Link>
            <Link
              ...
              onClick={() => setShowMobileMenu(false)}
              className={`block py-3 px-4 rounded-lg hover:bg-gray-100 ${
                pathname === "/about-us" ? "font-bold text-[#4A5FBF] bg-blue-50" : "text-gray-700"
              }`}
            >
              About us
            </Link>
            <Link
              ...
              onClick={() => setShowMobileMenu(false)}
              className={`block py-3 px-4 rounded-lg hover:bg-gray-100 ${
                pathname === "/contact" ? "font-bold text-[#4A5FBF] bg-blue-50" : "text-gray-700"
              }`}
            >
              Contact
            </Link>
